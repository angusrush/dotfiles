...
## Type: QssColor
c.colors.completion.item.selected.bg = nord['base02']

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = nord['base02']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = nord['base02']

## Foreground color of the selected completion item.
## Type: QtColor
c.colors.completion.item.selected.fg = nord['cyan']

## Foreground color of the matched text in the completion.
## Type: QssColor
c.colors.completion.match.fg = nord['magenta']
...
## Type: QssColor
c.colors.completion.scrollbar.bg = nord['base3']

## Color of the scrollbar handle in completion view.
## Type: QssColor
c.colors.completion.scrollbar.fg = nord['base3']
...
## Type: QssColor
c.colors.statusbar.command.private.bg = nord['magenta']
...
## Type: QssColor
c.colors.statusbar.private.bg = nord['magenta']
...
## Type: QtColor
c.colors.tabs.selected.even.bg = nord['base04']

## Foreground color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.fg = nord['cyan']

## Background color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['base04']

## Foreground color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.fg = nord['cyan']
...
## Type: ShellCommand
c.editor.command = ['termite', '--name', 'popupeditor', '-e', 'nvim {file}', '-c', 'normal {line}G{column0}l']
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://www.nytimes.com/'
...
c.url.start_pages = ['https://www.nyt.com/']
